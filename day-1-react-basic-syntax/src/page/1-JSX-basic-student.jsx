...
// 자바스크립트 함수인데 어떻게 HTML을 렌더링 하고 있는가..

export default function Page() {
  // JSX는 JavaScript XML의 약자로, 
  // JavaScript에 HTML(및 XML) 문법 규칙을 적용한 새로운 문법이다.
  ...
  // <div></div> => babel => /*#__PURE__*/React.createElement("div", null)
  const jsDiv = /*#__PURE__*/React.createElement("div");
